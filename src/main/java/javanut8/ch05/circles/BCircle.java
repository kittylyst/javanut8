...
public class BCircle implements Comparable<BCircle> {
    ...
    private BCircle(CircleBuilder cb) {
        if (cb.r < 0) throw new IllegalArgumentException("negative radius");
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof BCircle)) return false;
        BCircle that = (BCircle) o;                 // Cast to our type
    ...
    public int compareTo(BCircle that) {
